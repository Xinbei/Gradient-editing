...
SparseMatrix<float> getA_2D(const FloatImage &maskDes) {
    int N = maskDes.width() * maskDes.height();
...
//                if (i == j)
//                    A(i, j) = -4;
//                else if (maskDes(i+1) < 0.5f || maskDes(i-1) < 0.5f ||
//                         maskDes(i+maskSrc.width()) < 0.5f || maskDes(i-maskSrc.width()) < 0.5f) {
//                    // TODO: smartAccessor
//                    A(i, j) = 1;
//                }
//                else
...
//            }
//            else {
//                b(j * imDes.height() + i) = imDes(i, j, channel);
//            }
        }
    }
    return b;
