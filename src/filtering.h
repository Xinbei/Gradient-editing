...
// extra
FloatImage boxBlur_filterClass_separable(const FloatImage &im, const int &k, bool clamp=true);
FloatImage boxBlur_filterClass_incremental(const FloatImage &im, const int &k, bool clamp=true);
FloatImage boxBlur_filterClass_sNi(const FloatImage &im, const int &k, bool clamp=true);
FloatImage gaussianBlur_box(const FloatImage &im, int k, float sigma, bool clamp=true);
FloatImage miniaturize(const FloatImage &im, float strength, int focal, float sigma, float truncate=3.0, bool clamp=true);
